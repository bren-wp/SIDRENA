...
foreach ( array( 'sidrena-support', 'support_tab', 'about_tab', 'help_tab', 'dashicons-pdf', 'Zatraži postavljanje - %s', 'Jednokratno početno postavljanje', 'Dobrovoljna donacija za razvoj', 'logo-wordpress-light.svg', 'logo-woocommerce-light.svg', 'admin/css/brand.css' ) as $needle ) {
