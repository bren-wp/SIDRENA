...
Kompletan vizualni sustav nalazi se u `branding/`, dok su svi runtime logotipi i ikone lokalno u `assets/images/`. Svaki instalacijski ZIP 1.0.3 nosi vlastiti edition-specific SVG branding te renderirane PNG hero, cover, CTA, dokumentacijske, app-card, compact, social i WordPress.org banner assete u `branding/rendered/`. Plugin ne ovisi o vanjskom CDN-u za svoj administratorski identitet.

## Zašto SIDRENA 1.0.3

**SIDRENA 1.0.3** spaja svakodnevni rad s cijenama i produkcijski administratorski UX u jedan pregledan sustav. Umjesto paralelnih tablica, ručnih izvoza i odvojenih evidencija, Sidrena koristi podatke vašeg odabranog izdanja i daje vam jasnije mjesto za upravljanje objavom i poviješću cijena.

Izdanje 1.0.3 donosi:
...
- `sidrena-wordpress-1.0.3.zip`
- `sidrena-woocommerce-1.0.3.zip`
