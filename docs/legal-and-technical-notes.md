...
Sidrena 1.0.3 koristi eksplicitnu oznaku primjenjivosti jedinične cijene. Administrator mora provjeriti je li proizvod obuhvaćen pravilom ili iznimkom; plugin to ne zaključuje automatski iz kategorije proizvoda.
...
Sidrena 1.0.3 stabilna release linija koristi zasebne provjere za:
...
Službeni release smije nastati samo kroz GitHub release workflow i objavljuje dva instalacijska ZIP-a te njihove `.sha256` provjere: `sidrena-wordpress-1.0.3.zip`, `sidrena-wordpress-1.0.3.zip.sha256`, `sidrena-woocommerce-1.0.3.zip` i `sidrena-woocommerce-1.0.3.zip.sha256`.
